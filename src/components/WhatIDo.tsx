        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Building Reliable Pipelines</h4>
              <p>
                Designing and implementing robust CI/CD pipelines with security
                gates and automated testing. From code commit to production
                deployment, I ensure reliable and secure delivery.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Engineering highly available cloud infrastructure with
                Infrastructure as Code. From VPC design to auto-scaling clusters,
                I build systems that are resilient and cost-effective.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
